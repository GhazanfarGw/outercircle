        ...
        <div className='mx-auto items-center md:px-10 px-5 md:py-20 py-0'>
            ...
            <Slider ref={sliderRef} {...settings}>
                ...
                <div key={index} className="md:py-20 py-8 md:pt-14 px-2">
                    <div className="bg-[#f2f5f8] rounded-lg border-2 border-opacity-20 py-8 w-auto mx-2 hover:scale-105 duration-200 hover:border-opacity-80 border-[#1E4579] text-center">
                        <div className="w-40 h-40 my-5 mx-auto rounded-full border-4 hover:border-opacity-80 border-[#1790E8] text-center">
                            <h1 className="py-12 text-5xl font-bold text-[#000000]">{slide.label}</h1>
                        </div>
                    </div>
                </div>
                ))}
