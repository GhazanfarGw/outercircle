        ...
        <div className='mx-auto items-center md:px-10 px-5 md:py-20 py-16'>
            ...
            <div className='pt-14'>
                <div className='grid lg:grid-cols-5 md:grid-cols-3 md:gap-0 gap-5 md:pb-8'>
                    <div data-aos="zoom-in-up" data-aos-delay="100" className='flex md:grid items-center md:mx-auto md:pt-5 md:px-2 px-3 md:border-0 border-2 border-[#1790E8]'>
                        <div className='md:h-36 md:w-36 w-14 hover:scale-105 duration-200 items-center md:text-center md:mx-auto'>
                            <img className='items-center md:text-center py-4 md:w-auto w-2/2' src='./icons/icons8-student-100 copy.png' alt='icons'/>
                        </div>
                        <p className='md:text-center md:pt-5 py-2 font-semibold md:font-bold md:text-base text-sm md:border-0 md:px-0 md:ml-0 border-l-4 pl-2 ml-2 border-[#A04FC8]'>
                            Aspiring Apprentice <br className='hidden md:block lg:block'/> Network
                        </p>
                    </div>
                    <div data-aos="zoom-in-up" data-aos-delay="100" className='flex md:grid items-center md:mx-auto md:pt-5 md:px-2 px-3 md:border-0 border-2 border-[#1790E8]'>
                        <div className='md:h-36 md:w-36 w-14 hover:scale-105 duration-200 items-center md:text-center md:mx-auto'>
                            <img className='items-center md:text-center py-4 md:w-auto w-2/2' src='./icons/2.png' alt='icons'/>
                        </div>
                        <p className='md:text-center md:pt-5 py-2 font-semibold md:font-bold md:text-base text-sm md:border-0 md:px-0 md:ml-0 border-l-4 pl-2 ml-2 border-[#A04FC8]'>
                            Outreach Initiative
                        </p>
