...
const items = [
  {
    ...
    brief: 'Brief: Join a supportive community of aspiring apprentices, access mentorship, and connect with industry professionals to kickstart your apprenticeship journey.'
  },
  {
    icon: './icons/2.png',
    ...
    brief: 'Brief: Engage with schools and communities to raise awareness about apprenticeships, provide valuable insights, and inspire the next generation of apprentices.'
  },
  {
    icon: './icons/1.png',
    ...
    brief: 'Brief: Partner with us to streamline your recruitment process, find the best apprentice talent, and ensure a seamless onboarding experience.'
  },
  {
    icon: './icons/3.png',
    ...
    brief: 'Brief: Participate in our exciting events and socials, from workshops and networking sessions to fun gatherings, designed to enrich your apprenticeship experience.'
  },
  {
    icon: './icons/4.png',
    ...
    brief: 'Brief: Access a curated collection of essential resources, including guides, templates, and tools, to help you succeed in your apprenticeship journey.'
  }
];
        ...
        <div className='pt-28'>
          <div className='grid lg:grid-cols-5 md:grid-cols-3 md:pb-8'>
            {items.map((item, index) => (
              ...
              >
                <div className='md:h-24 md:w-24 w-12 hover:scale-105 duration-200 items-center mx-auto'>
                  <img
                    className='items-center md:py-4 pt-5 md:pt-0 w-full'
                    src={item.icon}
                    alt='icons'
                  />
                </div>
                <div className="flex items-center justify-center md:px-5">
                  <p className='md:text-center text-sm md:pt-5 pt-3 ml-2 md:ml-0 py-2 text-left'>
                    {hoveredItem === index ? item.brief : item.title}
                  </p>
                </div>
