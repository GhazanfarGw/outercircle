          ...
          <div className='text-white lg:max-w-2xl'>
            ...
            <div className='md:flex'>
              <div className="flex items-center md:gap-x-5 md:mt-16 pt-8 md:pt-0">
                <a target="_black" href='https://outercircleltd.fillout.com/t/rRwwmpJy4musA' className="flex bg-gradient-to-l from-[#1790E8] to-[#A04FC8] items-center shadow-xl rounded-r-lg md:px-8 px-5 md:py-4 py-3 text-white text-sm font-semibold mr-4">
