...
function Logo({ isScrolled }) {
  ...
  return (
    <>
        {isScrolled ? (
        <header onClick={handleScrollToTop} className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center md:py-2 bg-white border-b shadow-lg">
            <div className="mx-auto items-center duration-500 md:pt-2">
                <div className="flex items-center">
                    <div className="flex items-center max-w-screen-2xl justify-between mx-auto w-full">
                        <div className="z-30 flex-shrink-0 pb-2 pt-2 md:pt-0  items-center duration-500">
                            <a href="/">
                            ...
                            <div className="items-center flex flex-row space-x-2 justify-end duration-500">
                                <div className='flex items-center'>
                                    ...
                                    <a
                                      href="/register"
                                      className="
                                      items-center text-base md:text-sm bg-[#1E4579] hover:bg-opacity-80 relative h-10 duration-200 lg:px-8 md:px-4 px-4 flex justify-center flex-row text-[#fff] font-semibold tracking-wide"
                                    >
                                      Join the Communty
                                    </a>
                                </div>
        ...
        <header className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center md:py-2 bg-white">
            <div className="mx-auto items-center duration-500 md:pt-2">
                <div className="flex items-center">
                    <div className="flex items-center max-w-screen-2xl justify-between mx-auto w-full">
                    <div className="z-30 flex-shrink-0 pb-2 pt-5 md:pt-0  items-center duration-500">
                        ...
                        <div className="z-20 text-3xl md:hidden pt-5 px-3 text-black" onClick={() => setOpen(!open)}>
                            <ion-icon className="" name={`${open ? "close" : "menu"}`}></ion-icon>
                        </div>
                        <div className="hidden lg:block w-full duration-500 scroll-smooth z-40">
                            <div className="items-center flex flex-row space-x-2 justify-end duration-500">
...
//         <>
//             {isScrolled ? (
//                 <header onClick={handleScrollToTop} className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center bg-[#1E4579] md:py-2 md:border-b">
