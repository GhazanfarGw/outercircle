    ...
    <>
        ...
        <header onClick={handleScrollToTop} className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center py-2 bg-white border-b shadow-lg">
            ...
            <ul className={`md:hidden overflow-x-hidden bg-[#fff] fixed w-full overflow-y-visible bottom-0 top-16 mt-3 border-t duration-500 ${open ? "left-0" : "left-[-100%]"}`}>
                ...
                <li>
                  <Link to="/community" className="hover:bg-[#1790E8] border border-[#1790E8] items-center relative h-10 mt-8 tracking-wider duration-200 mx-10 justify-center flex rounded-sm">
                    Join the Community
                  </Link>
                </li>
            </ul>
        ...
        <header className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center md:py-2">
            ...
            <ul className={`md:hidden overflow-x-hidden bg-[#000000] fixed w-full overflow-y-visible bottom-0 py-32 mt-2 border-t duration-500 ${open ? "left-0" : "left-[-100%]"}`}>
                ...
                <li>
                  <Link to="/community" className="hover:bg-[#1790E8] text-[#dfdfdf] border border-[#1790E8] items-center relative h-10 mt-8 tracking-wider duration-200 mx-10 justify-center flex rounded-sm">
                    Join the Community
                  </Link>
                </li>
            </ul>
