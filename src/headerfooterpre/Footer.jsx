    ...
    return (
        <div className='bg-[#002147]'>
            <div className='max-w-screen-xl mx-auto justify-center md:pt-20 md:pb-10 md:px-10 py-10'>
                <h1 className='text-[#fff] md:text-base font-semibold text-sm justify-center pb-5 px-5 '>
                ...
                <div className='md:grid md:grid-cols-5 md:gap-8 max-w-screen-2xl mx-auto justify-center py-5 text-white px-7'>
                    <div className=''>
                        ...
                        <p className='text-sm text-[#fff] md:pt-4 pt-3 font-semibold'>
                    ...
                    <div className='md:pt-0 pt-10'>
                        ...
                        <p className='text-sm text-[#fff] md:pt-4 pt-2 font-semibold'>
                    ...
                    <div className='md:pt-0 pt-10'>
                        ...
                        <div className='pt-4'>
                            <div><a className='text-sm text-[#fff] md:pt-4 pt-2 pl-2 hover:text-[#1790E8] hover:font-bold duration-150 font-semibold' href="/">Home</a></div>
                            <div><a className='text-sm text-[#fff] md:pt-4 pt-2 pl-2 hover:text-[#1790E8] hover:font-bold duration-150 font-semibold' href="/students">Students</a></div>
                            <div><a className='text-sm text-[#fff] md:pt-4 pt-2 pl-2 hover:text-[#1790E8] hover:font-bold duration-150 font-semibold' href="/schools">Schools</a></div>
                            <div><a className='text-sm text-[#fff] md:pt-4 pt-2 pl-2 hover:text-[#1790E8] hover:font-bold duration-150 font-semibold' href="/grassroots">Grassroots</a></div>
                            <div><a className='text-sm text-[#fff] md:pt-4 pt-2 pl-2 hover:text-[#1790E8] hover:font-bold duration-150 font-semibold' href="/contact-us">Contact Us</a></div>
                        </div>
                    </div>
                    <div className='md:pt-0 pt-10'>
                        <h1 className='text-white text-base justify-center font-bold'>
                ...
                <div className='justify-center mx-auto md:text-center px-5'>
                    <div className='border-b border-[#1790E8] py-3'/>
                        <p className='md:text-sm text-xs text-[#fff] md:pt-5 pt-5 font-semibold'>
