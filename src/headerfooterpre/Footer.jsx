            ...
            <div className='max-w-screen-xl mx-auto justify-center md:pt-20 md:pb-10 md:px-10 py-10'>
                ...
                <div className='md:grid md:grid-cols-5 md:gap-16 max-w-screen-2xl mx-auto justify-center py-5 text-white px-7'>
                    ...
                    <div className='md:pt-0 pt-10'>
                        ...
                        <div className='pt-4'>
                            <div className='md:pt-2'><a className='text-sm text-[#fff] md:pt-5 pt-2 pl-2 hover:text-[#1790E8] hover:font-bold duration-150' href="/">Home</a></div>
                            <div className='md:pt-2'><a className='text-sm text-[#fff] pt-2 pl-2 hover:text-[#1790E8] hover:font-bold duration-150' href="/students">Students</a></div>
                            <div className='md:pt-2'><a className='text-sm text-[#fff] pt-2 pl-2 hover:text-[#1790E8] hover:font-bold duration-150' href="/schools">Schools</a></div>
                            <div className='md:pt-2'><a className='text-sm text-[#fff] pt-2 pl-2 hover:text-[#1790E8] hover:font-bold duration-150' href="/grassroots">Grassroots</a></div>
                            <div className='md:pt-2'><a className='text-sm text-[#fff] pl-2 hover:text-[#1790E8] hover:font-bold duration-150' href="/contact-us">Contact Us</a></div>
                        </div>
                    </div>
                    <div className='md:pt-0 pt-10'>
                        <h1 className='text-white text-base justify-center font-bold'>
