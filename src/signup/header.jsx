...
function Logo({ isScrolled }) {
  ...
  return (
    <>
        {isScrolled ? (
          <header onClick={handleScrollToTop} className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center py-2 bg-white border-b shadow-lg">
            ...
            <ul className={`md:hidden overflow-x-hidden bg-[#fff] fixed w-full overflow-y-visible bottom-0 top-16 mt-3 border-t duration-500 ${open ? "left-0" : "left-[-100%]"}`}>
                ...
                <li>
                  <Link to="/signup" className="hover:bg-[#1790E8] border border-[#1790E8] items-center relative h-10 mt-8 tracking-wider duration-200 mx-10 justify-center flex rounded-sm">
                    Signup
                  </Link>
                </li>
            </ul>
        ...
        <header className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center md:py-2 bg-white border-b shadow-lg">
            <div className="mx-auto items-center duration-500 md:pt-2">
                <div className="flex items-center">
                    <div className="flex items-center max-w-screen-2xl justify-between mx-auto w-full">
                        <div className="z-30 flex-shrink-0 pb-3 md:pb-2 pt-3 md:pt-0 items-center duration-500">
                            <a href="/">
                                <img width={100} className='hidden md:block lg:block items-center duration-500' src='./outercircle.png' alt='Logo'/>
                                <img width={85} className='block md:hidden lg:hidden items-center duration-500' src='./outercircle.png' alt='Logo'/>
                            </a>
                        </div>
                        <div className="z-20 text-3xl md:hidden pt-3 px-3 text-black" onClick={() => setOpen(!open)}>
                            <ion-icon className="" name={`${open ? "close" : "menu"}`}></ion-icon>
            ...
            <ul className={`md:hidden overflow-x-hidden bg-[#000000] fixed w-full overflow-y-visible bottom-0 py-32 mt-2 border-t duration-500 ${open ? "left-0" : "left-[-100%]"}`}>
                ...
                <li>
                  <Link to="/signup" className="hover:bg-[#1790E8] text-[#dfdfdf] border border-[#1790E8] items-center relative h-10 mt-8 tracking-wider duration-200 mx-10 justify-center flex rounded-sm">
                    Signup
                  </Link>
                </li>
            </ul>
