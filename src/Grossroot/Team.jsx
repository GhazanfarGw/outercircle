  ...
  return (
    ...
    <div className='max-w-screen-xl mx-auto'>
        <div className='md:px-10 px-5 py-20 justify-center text-center mx-auto'>
            ...
            <div className='font-bold text-5xl flex gap-3 items-center justify-center mx-auto text-center pt-3'>
                <span>
                    OuterCircle
                </span>
                <img className='items-center' width={80} src='./outercircle.png' alt='logo'/>
                <span>Team</span>
            </div>
