...
export default function Dashboard() {
  return (
    <>
      <div id='grossroot' className='duration-500 min-h-screen w-full items-center justify-center mx-auto lg:px-10 md:px-10 sm:px-5 px-5 pb-10 overflow-hidden'>
          <div className='lg:grid lg:grid-cols-2 justify-between lg:gap-x-20 mx-auto items-center md:pt-44 overflow-hidden'>
            <div className='first items-center align-middle mx-auto md:pt-28 pt-24'>
            ...
            <div className='text-white lg:max-w-2xl'>
              <div className='lg:pt-28 pt-3'>
                <p className='third lg:pt-3 lg:text-7xl md:text-6xl text-5xl font-bold'>
                  About Us
                </p>
                <p className='fourth md:pt-8 pt-5 md:text-2xl text-base'>
