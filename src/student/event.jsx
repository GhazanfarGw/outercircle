...
export default function Event() {
  return (
    <>
    <div className=''>
        <div className='md:px-10 px-5 text-black md:py-32 py-12 items-center justify-center text-center mx-auto'>
            <h1 className='md:text-5xl text-3xl font-semibold'>
                In Person Events
            </h1>
            <div className='md:block lg:block hidden'>
                <img className='justify-center mx-auto max-w-5xl py-10' src='./Cricle_gr.png'/>
            </div>
